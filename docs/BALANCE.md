...
protection = clamp(
  (zoneCoverage + sealModifier + sensitiveModifier) * suitability,
  0, 100
)
```
...
| 1000 | premium müştəri sifarişləri *(tuning namizədi — playtest uzun gələrsə 800)* |
...
- İlk **6 sifariş** sabit ardıcıllıqdadır (öyrənmə əyrisi):
  1. telefon qutusu + streç film *(tutorial)*
